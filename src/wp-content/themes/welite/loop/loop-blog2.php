<!-- ## masonry-primary start ## -->
<div id="masonry-primary" class="col-xs-12 col-sm-12 col-md-8<?php echo ( inafx_theme_option( 'opt_blog_layout' ) == 5 ) ? ' pull-right' : '';?>">
    <div class="row">
        <!-- ## primary content start ## -->
        <div id="primary" class="blog-masonry-2col">
            <?php
            ...
            $posts_per_page = inafx_theme_option( 'opt_blog_masonry2col_pagesize' );
            if( is_home() || is_page() ) {
                $wp_query = null;
            ...
            ?>
            <!-- ## post-masonry start ## -->
            <div class="col-md-6 col-sm-6 col-xs-12 post-masonry">
                <?php
