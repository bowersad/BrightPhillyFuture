        ...
        function inafx_entry_author(){
            if ( inafx_theme_option( 'opt_show_post_meta' ) != 0 ) :
                if ( inafx_theme_option( 'opt_show_post_author' ) != 0 ) :
                    printf( '<span class="meta"> %4$s <span class="author vcard"><a class="url fn n" href="%1$s" title="%2$s" rel="author">%3$s</a></span></span>',
        ...
        function inafx_entry_date() {
            if ( inafx_theme_option( 'opt_show_post_meta' ) != 0 ) :
                if ( inafx_theme_option( 'opt_show_post_date_published' ) != 0 ) :
                    ...
                    $date = sprintf( '<span class="meta"> %3$s <span class="date"><time class="entry-date" datetime="%4$s">%1$s</time></span></span>',
                        esc_attr( get_the_date( $date_format ) ),
                        esc_html( sprintf( $format_prefix, get_post_format_string( get_post_format() ), get_the_date() ) ),
                        inafx_theme_option( 'opt_post_date_text' ),
        ...
        function inafx_post_format_icon(){
            if ( inafx_theme_option( 'opt_show_post_meta' ) != 0 ) :
                if ( inafx_theme_option( 'opt_show_post_format_icon' ) != 0 ) :
                    ...
                    switch ( $format ) {
                        case 'aside':
                            echo '<span class="meta"><span class="fa fa-file-text"></span></span>';
                            break;
                        case 'gallery':
                            echo '<span class="meta"><span class="fa fa-camera"></span></span>';
                            break;
                        case 'video':
                            echo '<span class="meta"><span class="fa fa-film"></span></span>';
                            break;
                        case 'quote':
                            echo '<span class="meta"><span class="fa fa-quote-left"></span></span>';
                            break;
                        case 'audio':
                            echo '<span class="meta"><span class="glyphicon glyphicon-music"></span></span>';
                            break;
                        case 'image':
                            echo '<span class="meta"><span class="fa fa-photo"></span></span>';
                            break;
                        case 'link':
                            echo '<span class="meta"><span class="glyphicon glyphicon-link"></span></span>';
                            break;
                        default:
                            echo '<span class="meta"><span class="fa fa-file-text-o"></span></span>';
                            break;
                    }
                endif;
            endif;
...
<nav class="navigation postings-navigation" role="navigation">
    <!-- ## nav-links start ## -->
    <div class="nav-links row">
        <!-- ## pager start ## -->
        <ul class="pager">
