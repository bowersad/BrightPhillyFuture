<?php
    ...
    @define( 'INAFX_CURRENT_THEME', 'welite');
    @define( 'INAFX_THEME_DOMAIN', 'welite');
    ...
    // may be deleted in next release.
    if ( ! function_exists( 'inafx_the_attachments' ) ) :
        function inafx_the_attachments() {
