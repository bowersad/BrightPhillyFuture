...
if ( !class_exists( 'inafx_options_config' ) ) {
    class inafx_options_config {
        ...
        function compiler_action($options, $css, $changed_values) {
            ...
            $header     .= '}'.PHP_EOL;
            $searchicon  = '#lnk-show-search{';
            $searchicon .= 'color:' .$options['opt_search_icon_color'];
            $searchicon .= '}'.PHP_EOL;
            ...
            $logo_text  .= '}'.PHP_EOL;
            $logo_text  .= '@media (max-width: 992px){'.PHP_EOL;
            $logo_text  .= '#header .logo .logo-text,#header .logo .logo-text a{';
            $logo_text  .= 'font-family:' .$options['opt_logo_text_sticky_typo']['font-family'] . ';';
            $logo_text  .= 'font-weight:' .$options['opt_logo_text_sticky_typo']['font-weight'] . ';';
            $logo_text  .= 'font-size:' .$options['opt_logo_text_sticky_typo']['font-size'] . ';';
            ...
            $logo_text  .= '}'.PHP_EOL;
            $logo_text  .= '}'.PHP_EOL;
            $logo_image  = '#header .logo .logo-image,#header .logo .logo-text{';
            $logo_image .= 'padding-top:' .$options['opt_logo_spacing']['padding-top'] . ';';
            $logo_image .= 'padding-bottom:' .$options['opt_logo_spacing']['padding-bottom'] . ';';
            $logo_image .= '}'.PHP_EOL;
            $logo_image .= '#header.header-fixed .logo .logo-image,#header.header-fixed .logo .logo-text{';
            $logo_image .= 'padding-top:' .$options['opt_logo_spacing_sticky']['padding-top'] . ';';
            $logo_image .= 'padding-bottom:' .$options['opt_logo_spacing_sticky']['padding-bottom'] . ';';
            $logo_image .= '}'.PHP_EOL;
            if ( $options['opt_logo_type'] == 'image' ) {
                $logo_image .= '#header .logo .logo-image img{';
                $logo_image .= 'width:' .$options['opt_logo_image_size_normal']['width'] . ';';
                $logo_image .= '}'.PHP_EOL;
                $logo_image .= '#header.header-fixed .logo .logo-image img{';
                $logo_image .= 'width:' .$options['opt_logo_image_size_sticky']['width'] . ';';
                $logo_image .= '}'.PHP_EOL;
                $logo_image .= '@media (max-width: 992px){'.PHP_EOL;
                $logo_image .= '#header .logo .logo-image img{';
                $logo_image .= 'width:' .$options['opt_logo_image_size_sticky']['width'] . ';';
                $logo_image .= '}'.PHP_EOL;
                $logo_image .= '}'.PHP_EOL;
        ...
        public function setSections() {
            $this->sections[] = array(
                ...
                'fields'    => array(
                    array(
                        'id'        => 'opt_body_layout',
                        'type'      => 'select',
                        'title'     => theme_locals( 'opt_layout_type' ),
                        'subtitle'  => theme_locals( 'opt_layout_type_desc' ),
                        'options'   => array(
                            'wide' => theme_locals( 'opt_layout_wide' ), 
                            'boxed' => theme_locals( 'opt_layout_boxed' )
                        ),
                        'default'   => 'wide'
                    ),
                    array(
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'            => 'opt_search_icon_color',
                        'type'          => 'color',
                        'title'         => theme_locals( 'opt_header_search_icon_color' ),
                        'subtitle'      => theme_locals( 'opt_header_search_icon_color_desc' ),
                        'default'       => '#222222',
                        'validate'      => 'color',
                        'transparent'   => false,
                        'compiler'      => true,
                    ...
                    array(
                        ...
                        'options'   => array(
                            'grid' => theme_locals( 'opt_header_ephemera_grid' ), 
                            'slideshow' => theme_locals( 'opt_header_ephemera_slideshow' )
                        ),
                        'default'   => 'slideshow'
                    ),
                    array(
                        ...
                        'default'   => '5000',
                        'required'  => array( 'opt_header_ephemera_style', 'equals', 'slideshow' )
                    ),
                    array(
                        'id'        => 'opt_header_ephemera_grid_height',
                        'type'      => 'text',
                        'title'     => theme_locals( 'opt_header_ephemera_grid_height' ),
                        'subtitle'  => theme_locals( 'opt_header_ephemera_grid_height_desc' ),
                        'default'   => '300',
                        'required'  => array( 'opt_header_ephemera_style', 'equals', 'grid' )
                    ),
                    array(
                        'id'        => 'opt_header_ephemera_grid_margin',
                        'type'      => 'text',
                        'title'     => theme_locals( 'opt_header_ephemera_grid_margin' ),
                        'subtitle'  => theme_locals( 'opt_header_ephemera_grid_margin_desc' ),
                        'default'   => '10',
                        'required'  => array( 'opt_header_ephemera_style', 'equals', 'grid' )
                    ),
                    array(
            ...
            $this->sections[] = array(
                ...
                'fields'    =>  array (
                    array  ( 
                           ...
                           'title'            =>   theme_locals( 'opt_logo_margins_normal' ), 
                           'subtitle'         =>   theme_locals( 'opt_logo_margins_normal_desc' ), 
                           'desc'             =>   theme_locals( 'opt_logo_margins_normal_desc_2' ), 
                           'compiler'         => true,
                           'default'              =>   array  ( 
                               'padding-top'       =>   '4px'  ,  
                               'padding-bottom'    =>   '4px'  ,  
                    ...
                    array  ( 
                           'id'               =>   'opt_logo_spacing_sticky'  , 
                           'type'             =>   'spacing'  , 
                           'mode'             =>   'padding'  , 
                           'units'            =>   array  (  'px'  ), 
                           'units_extended'   =>   'false'  , 
                           'title'            =>   theme_locals( 'opt_logo_margins_sticky' ), 
                           'subtitle'         =>   theme_locals( 'opt_logo_margins_sticky_desc' ), 
                           'desc'             =>   theme_locals( 'opt_logo_margins_sticky_desc_2' ), 
                           'compiler'         => true,
                           'default'              =>   array  ( 
                               'padding-top'       =>   '4px'  ,  
                               'padding-bottom'    =>   '4px'  ,  
                    ...
                    array(
                        'id'        => 'opt_logo_image_size_normal',
                        'type'      => 'dimensions',
                        'required'      => array('opt_logo_type', '=', 'image'),
                        'title'     => theme_locals( 'opt_logo_image_size_normal' ),
                        'subtitle'  => theme_locals( 'opt_logo_image_size_normal_desc' ),
                        'compiler'  => true,
                        'height'           => false,
                        'units'            =>   array  (  'px'  ), 
                        'units_extended'   =>   'false', 
                    ...
                    array(
                        'id'        => 'opt_logo_image_size_sticky',
                        'type'      => 'dimensions',
                        'required'      => array('opt_logo_type', '=', 'image'),
                        'title'     => theme_locals( 'opt_logo_image_size_sticky' ),
                        'subtitle'  => theme_locals( 'opt_logo_image_size_sticky_desc' ),
                        'compiler'  => true,
                        'height'           => false,
                        'units'            =>   array  (  'px'  ), 
                        'units_extended'   =>   'false', 
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        ...
                        'type'      => 'image_select',
                        'compiler'  => true,
                        'title'     => theme_locals( 'opt_blog_layout' ),
                        'subtitle'  => theme_locals( 'opt_blog_layout_desc' ),
                        'options'   => array(
                            '1' => array('alt' => theme_locals( 'opt_blog_1_column' ), 'img' => ReduxFramework::$_url . 'assets/img/1col.png'),
                            '2' => array('alt' => theme_locals( 'opt_blog_2_column_left_sidebar' ),  'img' => ReduxFramework::$_url . 'assets/img/2cl.png'),
                            '3' => array('alt' => theme_locals( 'opt_blog_2_column_right_sidebar' ), 'img' => ReduxFramework::$_url . 'assets/img/2cr.png'),
                            '4' => array('alt' => theme_locals( 'opt_blog_3_column_masonry' ), 'img' => ReduxFramework::$_url . 'assets/img/3-col-masonry.png'),
                            '5' => array('alt' => theme_locals( 'opt_blog_2_column_masonry_left_sidebar' ),  'img' => ReduxFramework::$_url . 'assets/img/2cl-masonry.png'),
                            '6' => array('alt' => theme_locals( 'opt_blog_2_column_masonry_right_sidebar' ), 'img' => ReduxFramework::$_url . 'assets/img/2cr-masonry.png')
                        ),
                        'default'   => '3'
                    ),
                    array(
                    ...
                    array(
                        'id'        => 'opt_post_date_text',
                        'type'      => 'text',
                        'required'  => array( 'opt_show_post_date_published', '=', true ),
                        'title'     => theme_locals( 'opt_post_date_prefix_text' ),
                        'subtitle'  => theme_locals( 'opt_post_date_prefix_text_desc' ),
                        'default'   => theme_locals( 'opt_post_date_prefix_text_default' ),
                    ),
                    array(
            ...
            $this->sections[] = array(
                'title'     => theme_locals( 'opt_blog_grid' ),
                'desc'      => theme_locals( 'opt_blog_grid_desc' ),
                'icon'      => 'fa fa-th-large',
                'fields'    =>  array(
                    array(
                        'id'        => 'opt_blog_masonry2col_pagesize',
                        'type'      => 'text',
                        'title'     => theme_locals( 'opt_blog_masonry_2_col_page_size' ),
                        'subtitle'  => theme_locals( 'opt_blog_masonry_2_col_page_size_desc' ),
                        'validate'  => 'numeric',
                        'default'   => '12',
                    ),
                    array(
                        'id'        => 'opt_blog_masonry3col_pagesize',
                        'type'      => 'text',
                        'title'     => theme_locals( 'opt_blog_masonry_3_col_page_size' ),
                        'subtitle'  => theme_locals( 'opt_blog_masonry_3_col_page_size_desc' ),
                        'validate'  => 'numeric',
                        'default'   => '12',
                    ),
                )
